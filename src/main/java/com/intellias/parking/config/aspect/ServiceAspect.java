package com.intellias.parking.config.aspect;
...
public final class ServiceAspect {
    ...
    private final static String SERVICE_POINTCUT = "com.intellias.parking.config.aspect.pointcut.CommonJoinPointConfig.serviceExecution()";
