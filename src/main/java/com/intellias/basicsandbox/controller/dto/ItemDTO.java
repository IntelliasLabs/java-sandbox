...
import com.intellias.basicsandbox.controller.validation.currency.CurrencyCode;
import com.intellias.basicsandbox.controller.validation.currency.ValidCurrency;
...
public class ItemDTO {
    ...
    @ValidCurrency(enumClass = CurrencyCode.class, groups = {Create.class, Update.class}, message = "{currency.invalid}")
